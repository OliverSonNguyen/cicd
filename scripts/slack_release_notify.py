...
class SlackReleaseNotify:
    ...
    def get_built_apks_from_environment(self):
        ...
        apk_paths = {
            "full": os.getenv("FULL_APK_URL") or self.full or 'n/a',
            "stripe": os.getenv("STRIPE_APK_URL") or self.stripe or 'n/a', 
            "adyen": os.getenv("ADYEN_APK_URL"),
            "ingenico": os.getenv("INGENICO_APK_URL")
        }
...
#           --send \
#           --webhook "https://hooks.slack.com/services/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" \
...
#           --send \
#           --webhook "https://hooks.slack.com/services/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" \
#           --full "dist/release-stripe-v13.1.3-1313-stripe-stg-submit=true/release_apps_on_device_armeabi-v7a_1313_13.1.3_d9f36b5_20250928_1048.apk" \
#           --stripe "dist/release-stripe-v13.1.3-1313-stripe-stg-submit=true/release_apps_on_device_armeabi-v7a_1313_13.1.3_d9f36b5_20250928_1048.apk" \
#           --changelog "Improve loading time \n New HomePage"


# dist/release-stripe-v13.1.3-1313-stripe-stg-submit=true/release_apps_on_device_armeabi-v7a_1313_13.1.3_d9f36b5_20250928_1048.apk
